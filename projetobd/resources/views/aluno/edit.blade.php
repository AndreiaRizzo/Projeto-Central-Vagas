        ...
        <form action="/aluno/{{$aluno->id}}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" name="codcurso" class="form-control" value="{{$aluno->cpfAluno}}" />
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    ...
                    <select name="curso_id" class="form-control">
                        @foreach ($cursos as $curso)
                            <option value="{{$curso->id}}" {{ $aluno->curso->id == $curso->id ? 'selected' : ''}}>
                                {{ $curso->nome}}
                            </option>
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" name="celResp" class="form-control" value="{{$aluno->celResp}}" />
                </div>
            </div>
            <div class="row mb-3">
                <div class="row">
